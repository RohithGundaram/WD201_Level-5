...
module.exports = (sequelize, DataTypes) => {
  class Todo extends Model {
    ...
    static async showList() {
      ...
      ItemsDueToday.forEach((todoItem) =>
        console.log(todoItem.displayableString())
      );
      console.log("\n");
      ...
      ItemsDueLater.forEach((todoItem) =>
        console.log(todoItem.displayableString())
      );
    }
    ...
    static async overdue() {
      ...
      const ItemsOverDue = await Todo.findAll({
    ...
    static async dueToday() {
      ...
      const ItemsDueToday = await Todo.findAll({
    ...
    static async dueLater() {
      ...
      const ItemsDueLater = await Todo.findAll({
